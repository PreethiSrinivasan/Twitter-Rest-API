...
@WebServlet("/TimelineTweet")
public class TimelineTweet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String requestUrl = "https://api.twitter.com/1.1/statuses/home_timeline.json";
		request.setAttribute("timelineTweets", invokeTwitterAPI(Verb.GET, requestUrl));
